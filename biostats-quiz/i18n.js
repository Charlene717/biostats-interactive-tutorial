...
(function(){
  ...
  const STR = {
    ...
    quizAllChapters: { zh:"生物統計 互動考題（全部章節）", en:"Biostatistics Interactive Quiz (All Chapters)" },
    quizErrataTitle: { zh:"生物統計 互動考題", en:"Biostatistics Interactive Quiz" },
